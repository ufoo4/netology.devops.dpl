...
В [env'ах](../qbec/clock-dpl/environments/stage.libsonnet) указан образ `"image": "foo4/clock-dpl",`  
Позже, на этапе CI\CD я поправлю конфигурацию.

<br>

Для деплоя приложения подготовил [qbec](../qbec/clock-dpl/) конфигурацию.   
